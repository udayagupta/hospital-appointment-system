...
export const generateDailySlots = (startTime, endTime, duration = 30, breakStart, breakEnd) => {
  ...
  while ((currentTime + duration) < endMinutes) {
    if (currentTime >= breakStartMinutes && currentTime < breakEndMinutes) continue;
